...
"""
Moduł zawiera klasę wyliczającą sume wiersza, którego projekcja ma najmniejszą wartość.
"""
import copy
import statistics
...
class MinProjectionHorizontalValueFeature(feature.Feature):
    """
    Klasa oblicza sume wiersza, którego projekcja ma najmniejszą wartość.
    Cecha .
    """

...
class Learning:
    ...
    def evaluate(self, data: LearningData):
        features, classes = data.get_testing_data()
        self.__model.evaluate(features, classes, verbose=2)
...
class ImageLearning:
    ...
    def evaluate(self, data: ImageLearningData):
        features, classes = data.get_testing_data()
        self.__model.evaluate(features, classes, verbose=2)
